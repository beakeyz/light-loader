...
debug: ## Run lightloader in Qemu
	@$(EMU) -m 1G -net none -M q35 -usb $(BIN_OUT)/$(OUT_IMAGE) -bios ./ovmf/OVMF.fd -enable-kvm -serial stdio -device usb-ehci -device usb-tablet -device usb-kbd -drive file=./install_test.img
