...
debug: ## Run lightloader in Qemu
	@$(EMU) -m 10G -net none -M q35 -usb $(BIN_OUT)/$(OUT_IMAGE) -drive file=./install_test.img -bios ./ovmf/OVMF.fd -enable-kvm -serial stdio -device usb-ehci -device usb-tablet
