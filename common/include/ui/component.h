...
{
  return (
      component->mouse_buffer && 
      component->mouse_buffer->x >= component->x && component->mouse_buffer->x < component->x + component->width &&
      component->mouse_buffer->y >= component->y && component->mouse_buffer->y < component->y + component->height
      );
}
